...
public:
    ...
    Tracking(System* pSys, ORBVocabulary* pVoc, FrameDrawer* pFrameDrawer, MapDrawer* pMapDrawer, Map* pMap,
             Map* pLastMap, KeyFrameDatabase* pKFDB, const string &strSettingPath, const int sensor);
    ...
    cv::Mat RelocalUsePnP(const cv::Mat &im, int pnpFlag);
    void testMatch(const cv::Mat &im);
